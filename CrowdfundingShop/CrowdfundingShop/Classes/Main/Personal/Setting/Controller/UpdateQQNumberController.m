...
#import "UpdateQQNumberController.h"

@interface UpdateQQNumberController ()
@property (weak, nonatomic) IBOutlet UITextField *qqNumberText;

@end

@implementation UpdateQQNumberController
...
- (void)viewDidLoad {
    ...
    /**用户昵称*/
    self.qqNumberText.text=self.qqNumber;
}
/**
 *  返回
 */
